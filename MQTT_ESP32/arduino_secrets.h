...
extern const String SECRET_SSID = "oussema";		// unless PIN is deactivated, specify your SIM card PIN number
extern const String SECRET_WIFI_PASS = "0000011112";					// specify the APN name (if needed)
...
extern const String SECRET_LIVEOBJECTS_API_KEY = "c04db3b149e644359722298e3a435241";
